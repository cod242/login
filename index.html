    ...
    <div class="page login-page" id="loginPage">
        <div class="login-container">
            <div class="login-form">
                ...
                <div class="error-message" id="loginErrorMessage">Lütfen tüm alanları doldur!</div>
        ...
        <div class="container">
                ...
                <div class="messages">
                    <div class="message">
                        ...
                        <div class="message-content">
                            <h4>Kullanıcı1 <span class="timestamp">Bugün 14:12</span></h4>
                    ...
                    <div class="message">
                        <div class="avatar"></div>
                        <div class="message-content">
                            <h4>Kullanıcı2 <span class="timestamp">Bugün 14:15</span></h4>
                            <p>İyiyim, sen nasılsın?</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="members">
                <div class="user-profile">
                    ...
                    <h3>Kullanıcı1</h3>
                    <p>Gelen Arama</p>
                    <button class="join">Aramaya Katıl</button>
                    <button class="decline">Reddet</button>
                </div>
            </div>
        </div>
    </div>
